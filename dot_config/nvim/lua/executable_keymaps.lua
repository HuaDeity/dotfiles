...
vim.keymap.set('n', '<leader>fs',":SearchSession<CR>" , { desc = '[F]ind [S]ession' })
...
vim.keymap.set("n", "be", ":BufferLineSortByExtension<CR>", { silent = true })
vim.keymap.set("n", "bd", ":BufferLineSortByDirectory<CR>", { silent = true })
...
-- [[Dashboard]]
vim.keymap.set('n', '<leader>sl',":SessionManager load_last_session<CR>" , { desc = '[S]ession [L]oad' })
vim.keymap.set('n', '<leader>fn',":DashboardNewFile<CR>" , { desc = '[F]ile [N]ew' })
