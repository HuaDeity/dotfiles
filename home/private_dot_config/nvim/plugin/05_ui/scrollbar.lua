...
vim.pack.add { "https://github.com/Isrothy/neominimap.nvim", "https://github.com/dstein64/nvim-scrollview" }

vim.keymap.set("n", "<leader>umrr", "<cmd>Neominimap Refresh<cr>", { desc = "Refresh global minimap" })
vim.keymap.set("n", "<leader>umrw", "<cmd>Neominimap WinRefresh<cr>", { desc = "Refresh minimap for current window" })
vim.keymap.set("n", "<leader>umrt", "<cmd>Neominimap TabRefresh<cr>", { desc = "Refresh minimap for current tab" })
vim.keymap.set("n", "<leader>umrb", "<cmd>Neominimap BufRefresh<cr>", { desc = "Refresh minimap for current buffer" })

require("scrollview").setup {
  excluded_filetypes = { "snacks_dashboard", "snacks_layout_box", "noice" },
  signs_on_startup = {
    "cursor",
    "search",
    "diagnostics",
